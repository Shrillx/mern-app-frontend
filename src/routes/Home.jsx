...
const focusCardsData = [
    {
        ...
        imgUrl: "https://i.pinimg.com/564x/b4/2a/1b/b42a1bd9bd34eb6428795d4885389a9a.jpg",
        followers: "999,243 Followers"
    },
    {
        title: "Illuminate ",
        description: "Connect with the music and discover yourself",
        imgUrl: "https://i.pinimg.com/564x/e7/3e/9e/e73e9e2901e20d7530c03258704475d5.jpg",
        followers: "73,243 Followers"
    },
    {
        title: "Dream & Drive",
        description: "Music to fly you to the clouds",
        imgUrl: "https://i.pinimg.com/564x/4d/6b/60/4d6b609a2726a6003f6acac67bbac348.jpg",
        followers: "1,934 Followers"
    },
    {
        title: "Alone Again",
        description: "Sad beats to give you company in your sorrows",
        imgUrl: "https://i.pinimg.com/564x/6d/71/9a/6d719ac2efe3b375c3c60c19aa5355e5.jpg",
        followers: "13,32 Followers"
    },
    {
        title: "Hearbeat",
        description: "Focus with deep techno and tech house",
        imgUrl: "https://i.pinimg.com/564x/cc/ea/dc/cceadc2a14ce9cb497121f813037af60.jpg",
...
const spotifyPlaylistsCardData = [
    {
        ...
        imgUrl: "https://i.pinimg.com/564x/ed/99/3c/ed993cb3b2bdf43a3509f58ae217be4b.jpg",
    },
    {
        title: "Deep Focus",
...
const Home = () => {
    return (
        <div className="h-full w-full flex">
            ...
            <div className="h-full w-4/5 overflow-auto bg-gradient-to-t from-black via-gray-800 to-black">
...
const Card = ({title, description, imgUrl,followers}) => {
    return (
        <div className="bg-black bg-opacity-40 w-1/5 p-4 rounded-lg ">
            ...
            <div className="text-gray-500 text-sm pt-3 font-semibold"> {followers}</div>
        </div>
    );
};
